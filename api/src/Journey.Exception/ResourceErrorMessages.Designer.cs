...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The date of the trip must be after today.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The end date of the trip must be equal to or after the Start Date.
        /// </summary>
